...
-   Use the [tools for verifying drivers](devtest.tools_for_verifying_drivers) while you are developing your driver. For guidelines about when to use specific verification tools, see [Analyzing a Driver using Code Analysis and Verification Tools](analyzing_driver_quality_by_using_code_analysis_tools.md) and the [Survey of Verification Tools](devtest.survey_of_verification_tools).
