<span id="vsdriver.deploying_a_driver_to_a_test_computer"></span>Deploying a Driver to a Test Computer
======================================================================================================
...
The deployment properties are only available if you have a driver package. If your driver solution does not have a driver package project, you need to add one. The driver package contains components, such as the INF file that are needed for installation. For more information, see [Driver Packages](devinst.driver_packages) and [Creating a Driver Package](creating_a_driver_package.md).
