...
Sets the properties for the [**Inf2Cat**](devtest.inf2cat) tool. The **Inf2Cat** tool can be used to create catalog files for any driver package that has an INF file.
...
<td align="left"><p>Runs the <a href="devtest.inf2cat"><strong>Inf2Cat</strong></a> tool on any INF files in the project (for example, .inf, .inx, or .inv files).</p></td>
</tr>
<tr class="even">
...
<p>This setting is equivalent to specifying the <a href="devtest.inf2cat"><strong>Inf2Cat</strong></a> option <strong>/os:</strong><em>WindowsVersionList</em>.</p></td>
</tr>
<tr class="odd">
...
<p>This setting is equivalent to specifying the <a href="devtest.inf2cat"><strong>Inf2Cat</strong></a> option <strong>/pageHashes[:</strong><em>file1</em><strong>][,</strong><em>file2</em><strong>]...]</strong>.</p></td>
</tr>
<tr class="even">
...
<p>This setting is equivalent to specifying the <a href="devtest.inf2cat"><strong>Inf2Cat</strong></a> option <strong>/pe[:</strong><em>file1</em><strong>[,</strong><em>file2</em><strong>]...]</strong>.</p></td>
</tr>
<tr class="odd">
...
<p>This setting is equivalent to specifying the <a href="devtest.inf2cat"><strong>Inf2Cat</strong></a> option <strong>/drm[:</strong><em>file1</em><strong>[,</strong><em>file2</em><strong>]...]</strong>.</p></td>
</tr>
<tr class="even">
...
<p>This setting is equivalent to specifying the <a href="devtest.inf2cat"><strong>Inf2Cat</strong></a> option <strong>/verbose</strong>.</p></td>
</tr>
<tr class="odd">
...
<p>This setting is equivalent to specifying the <a href="devtest.inf2cat"><strong>Inf2Cat</strong></a> option <strong>/nocat</strong>.</p></td>
</tr>
<tr class="even">
...
<p>This setting is equivalent to specifying the <a href="devtest.inf2cat"><strong>Inf2Cat</strong></a> option <strong>/uselocaltime</strong>.</p></td>
</tr>
</tbody>
</table>
...
For more information about the Inf2Cat tool, see [Using Inf2Cat to Create a Catalog File](devinst.using_inf2cat_to_create_a_catalog_file).

For information about property pages and projects, see the [WDK and Visual Studio build environment](devtest.wdk_and_visual_studio_build_environment).
